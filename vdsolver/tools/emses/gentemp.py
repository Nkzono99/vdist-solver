...
def parse_args():
    ...
    parser.add_argument('--type', '-t', default='vdsolver')
...
def gentemp():
    args = parse_args()
    if args.type == 'vdsolver':
        gentemp_vdsolver(args)
    elif args.type == 'backtrace':
        gentemp_backtrace(args)


def gentemp_vdsolver(args):
